...
const PModule: React.FC<{bgStyle: React.CSSProperties, cropContainerRef: React.RefObject<HTMLDivElement>, text: string, name?: string}> = ({bgStyle, cropContainerRef, text, name}) => {
